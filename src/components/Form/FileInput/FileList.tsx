    ...
    <div className="mt-4 space-y-3">
      {files.map((file) => {
        return (
          ...
          >
            <div className="rounded-full border-4 border-brand-100 bg-brand-200 p-2 text-brand-600">
            ...
            <button
              type="button"
              className="ml-auto rounded-md p-2 hover:cursor-pointer hover:bg-zinc-50"
            >
